...
import { D as O } from "./@babel.7bf9beb3.js";
var l = "", b = "", w = "", W = "", C = v && "ontouchstart" in document.documentElement;
if (v) {
  var p = {
    Moz: "-moz-",
    ms: "-ms-",
...
var V = {
...
}, E = [A, N, V, B, D, U, H, I, L, R, _, $, q, F, J, Y], k = E.filter(function(e) {
  ...
  return e.push.apply(e, O(r.noPrefill)), e;
}, []), c, f = {};
if (v) {
...
//# sourceMappingURL=css-vendor.ea226be1.js.map
