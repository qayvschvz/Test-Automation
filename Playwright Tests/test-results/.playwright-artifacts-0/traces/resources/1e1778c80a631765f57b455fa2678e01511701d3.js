import { g as O } from "./@babel.7bf9beb3.js";
var _ = function() {
  if (typeof Map < "u")
    return Map;
  function e(t, n) {
...
var A = 20, x = ["top", "right", "bottom", "left", "width", "height", "size", "weight"], z = typeof MutationObserver < "u", T = function() {
  function e() {
    this.connected_ = !1, this.mutationEventsAdded_ = !1, this.mutationsObserver_ = null, this.observers_ = [], this.onTransitionEnd_ = this.onTransitionEnd_.bind(this), this.refresh = M(this.refresh.bind(this), A);
  }
...
function D(e) {
  ...
  if (!t && !n)
    return y;
  var r = c(e).getComputedStyle(e), i = S(r), o = i.left + i.right, s = i.top + i.bottom, a = h(r.width), u = h(r.height);
  if (r.boxSizing === "border-box" && (Math.round(a + o) !== t && (a -= b(r, "left", "right") + o), Math.round(u + s) !== n && (u -= b(r, "top", "bottom") + s)), !j(e)) {
...
}(), g = typeof WeakMap < "u" ? /* @__PURE__ */ new WeakMap() : new _(), w = function() {
  function e(t) {
    if (!(this instanceof e))
      throw new TypeError("Cannot call a class as a function.");
    if (!arguments.length)
      throw new TypeError("1 argument required, but only 0 present.");
    var n = T.getInstance(), r = new F(t, n, this);
    g.set(this, r);
  }
  return e;
}();
...
const k = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  default: H
}, Symbol.toStringTag, { value: "Module" })), I = /* @__PURE__ */ O(k);
export {
  I as r
};
//# sourceMappingURL=resize-observer-polyfill.12d49da5.js.map
