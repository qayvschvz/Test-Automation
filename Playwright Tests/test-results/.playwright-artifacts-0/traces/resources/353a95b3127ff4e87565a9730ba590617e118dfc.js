var s = function o(r, e) {
  ...
  if (r && e && typeof r == "object" && typeof e == "object") {
    ...
    if (u = Object.keys(r), f = u.length, f !== Object.keys(e).length)
      return !1;
    for (t = f; t-- !== 0; )
      if (!Object.prototype.hasOwnProperty.call(e, u[t]))
        return !1;
    for (t = f; t-- !== 0; ) {
      var n = u[t];
      if (!o(r[n], e[n]))
...
//# sourceMappingURL=fast-deep-equal.dc650d63.js.map
